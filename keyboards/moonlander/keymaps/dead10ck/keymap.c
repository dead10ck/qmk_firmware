...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [L_BASE] = LAYOUT_moonlander(
    ...
    //|______________|______________|______________|________|________|______________|___________| |_____________|_________|________|__________|_____________|_____________|_____________|
    //|              |              |              |        |        |              |           | |             |         |        |          |             |             |             |
      LT(L_SYMB,KC_ESC),  KC_A,          KC_S,        KC_D,    KC_F,       KC_G,      MT_HYP_EQ,   TO(L_COLEMAK),  KC_H,     KC_J,     KC_K,       KC_L,       KC_SCOLON,    KC_QUOTE,
    //|______________|______________|______________|________|________|______________|___________| |_____________|_________|________|__________|_____________|_____________|_____________|
    //|              |              |              |        |        |              |                           |         |        |          |             |             |             |
    ...
    //|              |              |              |        |        |              |                           |         |        |          |             |             |             |
         TD(D_SYS),     TD(D_CAPS),     KC_LGUI,OSL(L_N_TMUX),OSL(L_TMUX),LALT(KC_TAB),                        TG(L_NUMPAD),KC_LGUI,  KC_RALT,  TD(D_WKSP_L), TD(D_WKSP_R), MO(L_MEDIA),
  ...
  [L_COLEMAK] = LAYOUT_moonlander(
    ...
    //|______________|______________|______________|________|________|______________|___________| |_____________|_________|________|__________|_____________|_____________|_____________|
    //|              |              |              |        |        |              |           | |             |         |        |          |             |             |             |
          _______,       _______,         KC_R,       KC_S,    KC_T,      KC_D,        _______,     TO(L_BASE),   _______,  KC_N,     KC_E,        KC_I,         KC_O,        _______,
    //|______________|______________|______________|________|________|______________|___________| |_____________|_________|________|__________|_____________|_____________|_____________|
    //|              |              |              |        |        |              |                           |         |        |          |             |             |             |
  ...
  [L_SYMB] = LAYOUT_moonlander(
    ...
    //|______________|______________|______________|________|________|______________|___________| |_____________|_________|________|__________|_____________|_____________|_____________|
    //|              |              |              |        |        |              |           | |             |         |        |          |             |             |             |
          _______,       KC_EXLM,        KC_AT,     KC_LCBR, KC_RCBR,    KC_AMPR,      KC_PIPE,     TO(L_MEDIA),  KC_HOME, KC_PGDN,  KC_PGUP,     KC_END,      _______,       KC_F12,
    //|______________|______________|______________|________|________|______________|___________| |_____________|_________|________|__________|_____________|_____________|_____________|
    //|              |              |              |        |        |              |           | |             |         |        |          |             |             |             |

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 LT(L_SYMB, KC_ESC),     KC_A,          KC_S,         KC_D,         KC_F,         KC_G,                                                  KC_H,         KC_J,        KC_K,        KC_L,       KC_SCLN,  LT(L_MEDIA, KC_QUOT),
  ...
  //|______________|______________|______________|_____________|_____________|_____________|                                        |_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
      TO(L_BASE),       _______,      _______,       KC_PGDN,      _______,      _______,                                               KC_LEFT,      KC_DOWN,      KC_UP,     KC_RIGHT,    _______,     _______,
  //|______________|______________|______________|_____________|_____________|_____________|                                        |_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
  ...
  //|______________|______________|______________|_____________|_____________|_____________|                                        |_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
      TO(L_BASE),       _______,      _______,       KC_LPRN,     KC_RPRN,      KC_TILD,                                                KC_PERC,      KC_AMPR,     KC_PIPE,     KC_MINUS,   KC_DLR,      _______,
  //|______________|______________|______________|_____________|_____________|_____________|                                        |_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
  ...
  //|______________|______________|______________|_____________|_____________|_____________|                                        |_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
      TO(L_BASE),       _______,      _______,       RGB_MOD,      RGB_RMOD,     _______,                                               _______,      KC_VOLD,    KC_VOLU,  KC_AUDIO_MUTE,HYPER(KC_M),   _______,
  //|______________|______________|______________|_____________|_____________|_____________|                                        |_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
  ...
  // _______________________________________________________________________________________                                         _____________________________________________________________________________
  //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
        _______,         KC_1,         KC_2,          KC_3,          KC_4,        KC_5,                                                KC_SLASH,       KC_7,        KC_8,        KC_9,      KC_MINUS,    KC_SLASH,
  //|______________|______________|______________|_____________|_____________|_____________|                                        |_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
      TO(L_BASE),       _______,      _______,       _______,      _______,      _______,                                             KC_ASTERISK,     KC_4,        KC_5,        KC_6,      KC_PLUS,    KC_ASTERISK,
  //|______________|______________|______________|_____________|_____________|_____________|                                        |_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
        _______,        _______,      _______,       _______,      _______,      _______,                                              KC_EQUAL,       KC_1,        KC_2,        KC_3,      KC_DOT,      KC_DOT,
  //|______________|______________|______________|_____________|_____________|_____________|_________________     __________________|_____________|____________|____________|____________|____________|___________|
  //                                                       |              |                |                 |   |                  |                      |                |
                                                                _______,        _______,         _______,            KC_BACKSPACE,            KC_0,             KC_ENTER
  //                                                       |______________|________________|_________________|   |__________________|______________________|________________|
  ),
  ...
  //|______________|______________|______________|_____________|_____________|_____________|                                        |_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
      TO(L_BASE),       _______,      _______,       _______,      _______,      _______,                                               M_MGC_R,      M_MGC_E,     M_MGC_I,     M_MGC_S,     M_MGC_U,    M_MGC_B,
  //|______________|______________|______________|_____________|_____________|_____________|                                        |_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
        _______,        _______,      _______,       _______,      _______,      _______,                                               _______,      _______,     _______,     _______,     _______,    _______,
  //|______________|______________|______________|_____________|_____________|_____________|_________________     __________________|_____________|____________|____________|____________|____________|___________|
  ...
  // //|______________|______________|______________|_____________|_____________|_____________|                                        |_____________|____________|____________|____________|____________|___________|
  // //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
  //      TO(L_BASE),      _______,      _______,       _______,      _______,      _______,                                               _______,      _______,     _______,     _______,     _______,    _______,
  // //|______________|______________|______________|_____________|_____________|_____________|                                        |_____________|____________|____________|____________|____________|___________|
  // //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
  //       _______,        _______,      _______,       _______,      _______,      _______,                                               _______,      _______,     _______,     _______,     _______,    _______,
  // //|______________|______________|______________|_____________|_____________|_____________|_________________     __________________|_____________|____________|____________|____________|____________|___________|

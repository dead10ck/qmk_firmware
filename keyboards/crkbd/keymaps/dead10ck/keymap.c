...
#define CTMUX(kc) (K_C_TMUX | ((kc)&0xFF))
#define CNTMUX(kc) (K_C_NTMUX | ((kc)&0xFF))
...
enum custom_keycodes {
    ...
    // need one special keycode for any keys with mods held down, since they
    // require the high bits
    //
    // MIDI stuff
    //
    // QK_MIDI_ON = 0x7100,
    ...
    // keycodes for typing unicode characters are in this range:
    //
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  // ____________________________________________________________________________________________________             ______________ _____________________________________________________________________________
  //|              |              |              |             |             |             |             |           |              |             |            |            |            |            |           |
       TT(L_SYS),        KC_Q,          KC_W,         KC_E,         KC_R,         KC_T,        _______,                  _______,        KC_Y,         KC_U,        KC_I,        KC_O,        KC_P,     KC_MINUS,
  //|______________|______________|______________|_____________|_____________|_____________|_____________|           |______________|_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |             |           |              |             |            |            |            |            |           |
 LT(L_SYMB, KC_ESC),     KC_A,          KC_S,         KC_D,         KC_F,         KC_G,        _______,                  _______,        KC_H,         KC_J,        KC_K,        KC_L,       KC_SCLN,  LT(L_MEDIA, KC_QUOT),
  //|______________|______________|______________|_____________|_____________|_____________|_____________|           |______________|_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
  ...
  //|______________|______________|______________|_____________|_____________|_____________|_____________|           |______________|_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |             |           |              |             |            |            |            |            |           |
      TO(L_BASE),       _______,      _______,       KC_PGDN,      _______,      _______,      _______,                  _______,       KC_LEFT,      KC_DOWN,      KC_UP,     KC_RIGHT,    _______,     _______,
  //|______________|______________|______________|_____________|_____________|_____________|_____________|           |______________|_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
  ...
  //                                                       |______________|________________|_________________|   |__________________|______________________|________________|
    ...
    [L_SYMB] = LAYOUT_split_3x6_3_ex2(
  // ____________________________________________________________________________________________________             ______________ _____________________________________________________________________________
  //|              |              |              |             |             |             |             |           |              |             |            |            |            |            |           |
        _______,        _______,      _______,       KC_LCBR,     KC_RCBR,      KC_EQUAL,      _______,                  _______,       KC_GRAVE,     KC_EXLM,      KC_AT,      KC_BSLS,    KC_CIRC,     _______,
  //|______________|______________|______________|_____________|_____________|_____________|_____________|           |______________|_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |             |           |              |             |            |            |            |            |           |
      TO(L_BASE),       _______,      _______,       KC_LPRN,     KC_RPRN,      KC_TILD,       _______,                  _______,       KC_PERC,      KC_AMPR,     KC_PIPE,     KC_MINUS,   KC_DLR,      _______,
  //|______________|______________|______________|_____________|_____________|_____________|_____________|           |______________|_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
  ...
  // ____________________________________________________________________________________________________             ______________ _____________________________________________________________________________
  //|              |              |              |             |             |             |             |           |              |             |            |            |            |            |           |
        _______,        _______,      _______,       _______,      _______,      _______,      _______,                  _______,      TO(L_BASE),    KC_MPLY,     KC_MPRV,     KC_MNXT,     _______,    _______,
  //|______________|______________|______________|_____________|_____________|_____________|_____________|           |______________|_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |             |           |              |             |            |            |            |            |           |
      TO(L_BASE),       _______,      _______,       UG_NEXT,      UG_PREV,     _______,      _______,                  _______,       _______,      KC_VOLD,    KC_VOLU,  KC_AUDIO_MUTE,HYPER(KC_M),   _______,
  //|______________|______________|______________|_____________|_____________|_____________|_____________|           |______________|_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
        _______,        _______,      _______,       UG_SPDU,      UG_SPDD,      _______,                                               _______,      _______,     _______,     _______,     _______,    _______,
  //|______________|______________|______________|_____________|_____________|_____________|_________________     __________________|_____________|____________|____________|____________|____________|___________|
  //                                                       |              |                |                 |   |                  |                      |                |
                                                               UG_VALU,        UG_VALD,          _______,              _______,              UG_HUEU,            UG_HUED
  //                                                       |______________|________________|_________________|   |__________________|______________________|________________|
  ),

    [L_TMUX] = LAYOUT_split_3x6_3_ex2(
  // ____________________________________________________________________________________________________             ______________ _____________________________________________________________________________
  //|              |              |              |             |             |             |             |           |              |             |            |            |            |            |           |
        _______,   STMUX(KC_DQUO),STMUX(KC_PERC),STMUX(KC_ASTR),STMUX(KC_LPRN),  _______,      _______,                  _______,   CTMUX(KC_LEFT),CTMUX(KC_DOWN),CTMUX(KC_UP),CTMUX(KC_RIGHT),TMUX(KC_P),_______,
  //|______________|______________|______________|_____________|_____________|_____________|_____________|           |______________|_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |             |           |              |             |            |            |            |            |           |
      TO(L_BASE),       _______,   TMUX(KC_LBRC),  TMUX(KC_D),     _______,      _______,      _______,                  _______,   TMUX(KC_LEFT),TMUX(KC_DOWN),TMUX(KC_UP),TMUX(KC_RIGHT),TMUX(KC_COLON),_______,
  //|______________|______________|______________|_____________|_____________|_____________|_____________|           |______________|_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
        _______,        _______,    TMUX(KC_X),    TMUX(KC_C),   TMUX(KC_V),     _______,                                             TMUX(KC_N),    _______,     _______,     _______,     _______,      _______,
  //|______________|______________|______________|_____________|_____________|_____________|_________________     __________________|_____________|____________|____________|____________|____________|___________|
  //                                                       |              |                |                 |   |                  |                      |                |
                                                                _______,        _______,         _______,              _______,              _______,            _______
  //                                                       |______________|________________|_________________|   |__________________|______________________|________________|
    ...
    [L_N_TMUX] = LAYOUT_split_3x6_3_ex2(
  // ____________________________________________________________________________________________________             ______________ _____________________________________________________________________________
  //|              |              |              |             |             |             |             |           |              |             |            |            |            |            |           |
        _______,  SNTMUX(KC_DQUO),SNTMUX(KC_PERC),SNTMUX(KC_ASTR),SNTMUX(KC_LPRN),_______,     _______,                  _______, CNTMUX(KC_LEFT),CNTMUX(KC_DOWN),CNTMUX(KC_UP),CNTMUX(KC_RIGHT),NTMUX(KC_P),_______,
  //|______________|______________|______________|_____________|_____________|_____________|_____________|           |______________|_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |             |           |              |             |            |            |            |            |           |
      TO(L_BASE),       _______,   NTMUX(KC_LBRC), NTMUX(KC_D),    _______,      _______,      _______,                  _______,  NTMUX(KC_LEFT),NTMUX(KC_DOWN),NTMUX(KC_UP),NTMUX(KC_RIGHT),NTMUX(KC_COLON),_______,
  //|______________|______________|______________|_____________|_____________|_____________|_____________|           |______________|_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
        _______,        _______,    NTMUX(KC_X),   NTMUX(KC_C),  NTMUX(KC_V),    _______,                                             NTMUX(KC_N),    _______,     _______,     _______,     _______,    _______,
  //|______________|______________|______________|_____________|_____________|_____________|_________________     __________________|_____________|____________|____________|____________|____________|___________|
  //                                                       |              |                |                 |   |                  |                      |                |
                                                                _______,        _______,         _______,              _______,              _______,            _______
  //                                                       |______________|________________|_________________|   |__________________|______________________|________________|
    ...
    [L_NUMPAD] = LAYOUT_split_3x6_3_ex2(
  // ____________________________________________________________________________________________________             ______________ _____________________________________________________________________________
  //|              |              |              |             |             |             |             |           |              |             |            |            |            |            |           |
        _______,         KC_1,         KC_2,          KC_3,          KC_4,        KC_5,        _______,                  _______,      KC_SLASH,       KC_7,        KC_8,        KC_9,      KC_MINUS,    KC_SLASH,
  //|______________|______________|______________|_____________|_____________|_____________|_____________|           |______________|_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |             |           |              |             |            |            |            |            |           |
      TO(L_BASE),       _______,      _______,       _______,      _______,      _______,      _______,                  _______,     KC_ASTERISK,     KC_4,        KC_5,        KC_6,      KC_PLUS,     KC_COLON,
  //|______________|______________|______________|_____________|_____________|_____________|_____________|           |______________|_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
        _______,        _______,      _______,       _______,      _______,      _______,                                              KC_EQUAL,       KC_1,        KC_2,        KC_3,      KC_DOT,      KC_DOT,
  //|______________|______________|______________|_____________|_____________|_____________|_________________     __________________|_____________|____________|____________|____________|____________|___________|
  //                                                       |              |                |                 |   |                  |                      |                |
                                                                _______,        _______,         _______,            KC_BACKSPACE,            KC_0,             KC_0
  //                                                       |______________|________________|_________________|   |__________________|______________________|________________|
  ),

    [L_SYS] = LAYOUT_split_3x6_3_ex2(
  // ____________________________________________________________________________________________________             ______________ _____________________________________________________________________________
  //|              |              |              |             |             |             |             |           |              |             |            |            |            |            |           |
        _______,        _______,      _______,       _______,      _______,      _______,      _______,                  _______,       _______,       KC_F7,      KC_F8,        KC_F9,      _______,    QK_BOOT,
  //|______________|______________|______________|_____________|_____________|_____________|_____________|           |______________|_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |             |           |              |             |            |            |            |            |           |
      TO(L_BASE),       _______,      _______,   CALT(KC_DELETE),  _______,      _______,      _______,                  _______,       _______,       KC_F4,      KC_F5,        KC_F6,      _______,    _______,
  //|______________|______________|______________|_____________|_____________|_____________|_____________|           |______________|_____________|____________|____________|____________|____________|___________|
  //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
  ...
  //   [L_BLANK] = LAYOUT_split_3x6_3_ex2(
  // // ____________________________________________________________________________________________________             ______________ _____________________________________________________________________________
  // //|              |              |              |             |             |             |             |           |              |             |            |            |            |            |           |
  //       _______,        _______,      _______,       _______,      _______,      _______,      _______,                  _______,       _______,      _______,     _______,     _______,     _______,    _______,
  // //|______________|______________|______________|_____________|_____________|_____________|_____________|           |______________|_____________|____________|____________|____________|____________|___________|
  // //|              |              |              |             |             |             |             |           |              |             |            |            |            |            |           |
  //      TO(L_BASE),      _______,      _______,       _______,      _______,      _______,      _______,                  _______,       _______,      _______,     _______,     _______,     _______,    _______,
  // //|______________|______________|______________|_____________|_____________|_____________|_____________|           |______________|_____________|____________|____________|____________|____________|___________|
  // //|              |              |              |             |             |             |                                        |             |            |            |            |            |           |
  //       _______,        _______,      _______,       _______,      _______,      _______,                                               _______,      _______,     _______,     _______,     _______,    _______,
  // //|______________|______________|______________|_____________|_____________|_____________|_________________     __________________|_____________|____________|____________|____________|____________|___________|
...
void leader_end_user(void) {
    ...
    // enable bracketed paste
        ...
        SEND_STRING_DELAY("dead10ck", ss_waitms);
